...
public class themHoaDon_Dialog extends JDialog{
	...
	public themHoaDon_Dialog() {
		...
		txt_maSP = new JTextField(String.valueOf(sp.getIdSP()));
...
//		getContentPane().add(cbb_IMEI);
		...
		lbl_tongtien.setBounds(666, 244, 107, 27);
		...
		txt_tongtien.setBounds(666, 283, 158, 27);
		getContentPane().add(txt_tongtien);
		txt_tongtien.setColumns(10);
		
		txt_soluong = new JTextField("0");
		...
		table.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
		    ...
		    public void valueChanged(ListSelectionEvent e) {
		        ...
		        if (selectedRow != -1) { // Kiểm tra xem có hàng nào được chọn không
		            DefaultTableModel model = (DefaultTableModel) table.getModel();
		            int idSP = (int) model.getValueAt(selectedRow, 0); // Lấy idSP của hàng đã chọn
		...
		lbl_baohanh.setBounds(498, 334, 94, 14);
		...
		cbb_baohanh.setBounds(498, 359, 94, 22);
		...
		lbl_khuyenmai.setBounds(666, 336, 94, 14);
		...
		cbb_khuyenmai.setBounds(666, 359, 158, 22);
		...
		txt_soluong.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (soluong > soluongton) {
		            ...
		            txt_soluong.setText(""); // Clear the invalid input
				...
				txt_tongtien.setText(String.valueOf(gia*sl - gia*sl*km/100));
			}
		});
		btn_tao.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ctHoaDonDTO cthd = new ctHoaDonDTO(maHD, donGia, thanhTien, idkm, idbh, idSanPham, idHoaDon);
